...
public class AnalysisConstants {
	...
	public static final String DELETE_FROM_CLOUD_STORAGE_PARAM = "deleteFromCloudStorage";
	public static final String APPLICATION_VERSIONS_TO_EXPORT_PARAM = "appVersionsToExport";
	public static final String SCHEMA_HASH_PARAM = "schemaHash";
